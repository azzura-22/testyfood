...
<style>
    .hero-berita {
        ...
        url('{{ asset("storage/fotoE/".$berita->gambar) }}') center/cover no-repeat;
        height: 320px;
        color: #fff;
    }
...
<section class="container my-5">
    <div class="row justify-content-center">
        <div class="col-lg-9">
            ...
            {{-- GAMBAR UTAMA --}}
            <img src="{{ asset('storage/fotoE/'.$berita->gambar) }}"
            ...
            <div class="alert alert-warning">
                ...
                Silakan <a href="{{ route('login') }}">login</a> untuk memberi komentar.
            </div>
            @endauth
