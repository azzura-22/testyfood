...
<div class="container my-5">
    ...
    <div class="row align-items-center mb-5">
        ...
        <div class="col-lg-6">
            <div class="d-flex gap-3">
                <img src="{{ asset('images/about-1.jpg') }}" class="img-fluid rounded-4 shadow-sm about-img">
                <img src="{{ asset('images/about-2.jpg') }}" class="img-fluid rounded-4 shadow-sm about-img">
            </div>
        </div>
    </div>
    ...
    <div class="row align-items-center mb-5">
        <div class="col-lg-6 mb-4 mb-lg-0">
            <img src="{{ asset('images/visi.jpg') }}" class="img-fluid rounded-4 shadow-sm">
        </div>
        <div class="col-lg-6">
    ...
    <div class="row align-items-center mb-5">
        ...
        <div class="col-lg-6">
            <img src="{{ asset('images/misi.jpg') }}" class="img-fluid rounded-4 shadow-sm">
        </div>
    </div>
